...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000002614689700000001429c0e09(
...
class phpbbtemplatetwiglexer_000000002614689700000001429c0e09 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a134b5a41fe1541509836 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a134b5a41ff7656751854 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a134b5a41fab745312671 = array(
    ...
    {
        $this->initializer5a134b5a41ff7656751854 && $this->initializer5a134b5a41ff7656751854->__invoke($this->valueHolder5a134b5a41fe1541509836, $this, 'set_environment', array('env' => $env), $this->initializer5a134b5a41ff7656751854);

        return $this->valueHolder5a134b5a41fe1541509836->set_environment($env);
    }
    ...
    {
        $this->initializer5a134b5a41ff7656751854 && $this->initializer5a134b5a41ff7656751854->__invoke($this->valueHolder5a134b5a41fe1541509836, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a134b5a41ff7656751854);

        return $this->valueHolder5a134b5a41fe1541509836->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a134b5a41ff7656751854 && $this->initializer5a134b5a41ff7656751854->__invoke($this->valueHolder5a134b5a41fe1541509836, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a134b5a41ff7656751854);

        return $this->valueHolder5a134b5a41fe1541509836->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a134b5a41ff7656751854 = $initializer;
    }
    ...
    {
        $this->initializer5a134b5a41ff7656751854 && $this->initializer5a134b5a41ff7656751854->__invoke($this->valueHolder5a134b5a41fe1541509836, $this, '__get', array('name' => $name), $this->initializer5a134b5a41ff7656751854);

        if (isset(self::$publicProperties5a134b5a41fab745312671[$name])) {
            return $this->valueHolder5a134b5a41fe1541509836->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a134b5a41fe1541509836;
    ...
    {
        $this->initializer5a134b5a41ff7656751854 && $this->initializer5a134b5a41ff7656751854->__invoke($this->valueHolder5a134b5a41fe1541509836, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a134b5a41ff7656751854);
    ...
    {
        $this->initializer5a134b5a41ff7656751854 && $this->initializer5a134b5a41ff7656751854->__invoke($this->valueHolder5a134b5a41fe1541509836, $this, '__isset', array('name' => $name), $this->initializer5a134b5a41ff7656751854);
    ...
    {
        $this->initializer5a134b5a41ff7656751854 && $this->initializer5a134b5a41ff7656751854->__invoke($this->valueHolder5a134b5a41fe1541509836, $this, '__unset', array('name' => $name), $this->initializer5a134b5a41ff7656751854);
    ...
    {
        $this->initializer5a134b5a41ff7656751854 && $this->initializer5a134b5a41ff7656751854->__invoke($this->valueHolder5a134b5a41fe1541509836, $this, '__clone', array(), $this->initializer5a134b5a41ff7656751854);

        $this->valueHolder5a134b5a41fe1541509836 = clone $this->valueHolder5a134b5a41fe1541509836;
    }

    public function __sleep()
    {
        $this->initializer5a134b5a41ff7656751854 && $this->initializer5a134b5a41ff7656751854->__invoke($this->valueHolder5a134b5a41fe1541509836, $this, '__sleep', array(), $this->initializer5a134b5a41ff7656751854);

        return array('valueHolder5a134b5a41fe1541509836');
    }
    ...
    {
        return $this->initializer5a134b5a41ff7656751854;
    }
    ...
    {
        return $this->initializer5a134b5a41ff7656751854 && $this->initializer5a134b5a41ff7656751854->__invoke($this->valueHolder5a134b5a41fe1541509836, $this, 'initializeProxy', array(), $this->initializer5a134b5a41ff7656751854);
    }
    ...
    {
        return null !== $this->valueHolder5a134b5a41fe1541509836;
    }
    ...
    {
        return $this->valueHolder5a134b5a41fe1541509836;
    }
