...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000004c21548e000000016cbd4766(
...
class phpbbtemplatetwiglexer_000000004c21548e000000016cbd4766 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a134b8feeead726130876 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a134b8feeec5460465070 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a134b8feee64305970952 = array(
    ...
    {
        $this->initializer5a134b8feeec5460465070 && $this->initializer5a134b8feeec5460465070->__invoke($this->valueHolder5a134b8feeead726130876, $this, 'set_environment', array('env' => $env), $this->initializer5a134b8feeec5460465070);

        return $this->valueHolder5a134b8feeead726130876->set_environment($env);
    }
    ...
    {
        $this->initializer5a134b8feeec5460465070 && $this->initializer5a134b8feeec5460465070->__invoke($this->valueHolder5a134b8feeead726130876, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a134b8feeec5460465070);

        return $this->valueHolder5a134b8feeead726130876->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a134b8feeec5460465070 && $this->initializer5a134b8feeec5460465070->__invoke($this->valueHolder5a134b8feeead726130876, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a134b8feeec5460465070);

        return $this->valueHolder5a134b8feeead726130876->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a134b8feeec5460465070 = $initializer;
    }
    ...
    {
        $this->initializer5a134b8feeec5460465070 && $this->initializer5a134b8feeec5460465070->__invoke($this->valueHolder5a134b8feeead726130876, $this, '__get', array('name' => $name), $this->initializer5a134b8feeec5460465070);

        if (isset(self::$publicProperties5a134b8feee64305970952[$name])) {
            return $this->valueHolder5a134b8feeead726130876->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a134b8feeead726130876;
    ...
    {
        $this->initializer5a134b8feeec5460465070 && $this->initializer5a134b8feeec5460465070->__invoke($this->valueHolder5a134b8feeead726130876, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a134b8feeec5460465070);
    ...
    {
        $this->initializer5a134b8feeec5460465070 && $this->initializer5a134b8feeec5460465070->__invoke($this->valueHolder5a134b8feeead726130876, $this, '__isset', array('name' => $name), $this->initializer5a134b8feeec5460465070);
    ...
    {
        $this->initializer5a134b8feeec5460465070 && $this->initializer5a134b8feeec5460465070->__invoke($this->valueHolder5a134b8feeead726130876, $this, '__unset', array('name' => $name), $this->initializer5a134b8feeec5460465070);
    ...
    {
        $this->initializer5a134b8feeec5460465070 && $this->initializer5a134b8feeec5460465070->__invoke($this->valueHolder5a134b8feeead726130876, $this, '__clone', array(), $this->initializer5a134b8feeec5460465070);

        $this->valueHolder5a134b8feeead726130876 = clone $this->valueHolder5a134b8feeead726130876;
    }

    public function __sleep()
    {
        $this->initializer5a134b8feeec5460465070 && $this->initializer5a134b8feeec5460465070->__invoke($this->valueHolder5a134b8feeead726130876, $this, '__sleep', array(), $this->initializer5a134b8feeec5460465070);

        return array('valueHolder5a134b8feeead726130876');
    }
    ...
    {
        return $this->initializer5a134b8feeec5460465070;
    }
    ...
    {
        return $this->initializer5a134b8feeec5460465070 && $this->initializer5a134b8feeec5460465070->__invoke($this->valueHolder5a134b8feeead726130876, $this, 'initializeProxy', array(), $this->initializer5a134b8feeec5460465070);
    }
    ...
    {
        return null !== $this->valueHolder5a134b8feeead726130876;
    }
    ...
    {
        return $this->valueHolder5a134b8feeead726130876;
    }
